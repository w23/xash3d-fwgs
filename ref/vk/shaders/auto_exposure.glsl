...
#define AUTO_EXPOSURE_HISTOGRAM_BINS 16
#endif
...
const float AE_LOG_LUMINANCE_MIN = -12.;
const float AE_LOG_LUMINANCE_MAX = 8.;
const float AE_TARGET_GREY = 0.18;
const float AE_LOW_PERCENTILE = 0.05;
const float AE_HIGH_PERCENTILE = 0.98;
const float AE_ADAPT_DARKEN_SPEED = 0.12;
const float AE_ADAPT_LIGHTEN_SPEED = 0.05;
const float AE_MIN_EXPOSURE = 1. / 64.;
const float AE_MAX_EXPOSURE = 16.;
