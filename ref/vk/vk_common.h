...
#define Mem_AllocPool( name ) gEngine._Mem_AllocPool( name, 0, __FILE__, __LINE__ )
#define Mem_AllocPoolExt( name, flags ) gEngine._Mem_AllocPool( name, flags, __FILE__, __LINE__ )
